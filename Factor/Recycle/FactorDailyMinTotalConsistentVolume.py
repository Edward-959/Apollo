...
@author: 006688
一致交易因子：观察5分钟K线，如果abs(𝐶𝑙𝑜𝑠𝑒−𝑂𝑝𝑒𝑛)>=α×abs(𝐻𝑖𝑔ℎ − 𝐿𝑜𝑤)，α取0.95，计为实体K线，
实体K线成交量除以当日总成交量得到当日因子值，再求移动平均
"""
...
def main():
    ...
    for i in [10]:
        factor_name = "F_D_MinTotalConsistentVolume_" + str(i)   # 这个因子名可以加各种后缀，用于和相近的因子做区分
