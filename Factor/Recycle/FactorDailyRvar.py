# -*- coding: utf-8 -*-
# @Time    : 2018/11/26 13:32
# @Author  : 011673
# @File    : FactorDailyRvar.py
...
def factor_generator(stock_list, start_date, end_date, factor_file_dir_path, factor_file_name, n):
    ...
    ret_log = ret_log * ret_log
    rvar = ret_log.rolling(window=n, min_periods=1).sum()
    factor_data = rvar.rolling(window=n, min_periods=1).mean()
...
def main():
    ...
    n = 20
    factor_name = "F_D_Rvar_{}".format(n)
