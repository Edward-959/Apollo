...
factors_need_updated_list = \
    [
        ['FactorDailyHolderNumber', {}, 'F_D_Holdnumber.h5'],
        ['FactorDailyEV2DevideEBITDA', {}, 'F_D_EV2DevideEBITDA.h5'],
        ['FactorDailyCashRatio', {}, 'F_D_CashRatio.h5'],
        ['FactorDailyBPDeindustry', {}, 'F_D_BPDeindustry.h5'],
        ['FactorDailyCurrent', {}, 'F_D_Current.h5'],
        ['FactorDailyDebttoassets', {}, 'F_D_Debttoassets.h5'],
        # 这个因子于2019/3/12因xquant的数据与api不同而删掉 ['FactorDailyDivyieldDeindustry', {}, 'F_D_DivyieldDeindustry.h5'],
        ['FactorDailyEPDeindustry', {}, 'F_D_EPDeindustry.h5'],
        ['FactorDailyGrossprofitmargin_qDeindustry', {}, 'F_D_GrossprofitmarginDeindustry_q.h5'],
        ['FactorDailyQuick', {}, 'F_D_Quick.h5'],
        ['FactorDailyROEDeindustry', {}, 'F_D_ROEDeindustry.h5'],
        ['FactorDailySPDeindustry', {}, 'F_D_SPDeindustry.h5'],
        ['FactorDailyYoyProfitDeindustry', {}, 'F_D_YoyProfitDeindustry.h5'],
        ['FactorDailyPCF', {}, 'F_D_Pcf.h5'],
        ['FactorDailyProfitLinear', {}, 'F_D_ProfitLinear.h5'],
        ['FactorDailyQfaYoyeps', {}, 'F_D_QfaYoyeps.h5'],
        ['FactorDailyYoyocf', {}, 'F_D_Yoyocf.h5'],
        ['FactorDailyYoyroa', {}, 'F_D_Yoyroa.h5'],
        ['FactorDailyYoyroe', {}, 'F_D_Yoyroe.h5']
    ]
