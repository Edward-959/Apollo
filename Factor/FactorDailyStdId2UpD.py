...
根据FactorDailyStdId2中回归得到的残差，分别求出上行波动率和下行波动率，两者相加
"""
...
class FactorDailyStdId2UpD(DailyFactorBase):
    ...
    def factor_calc(self):
        ...
        for date in trading_days:
            ...
            ans_df.loc[date] = stock_res.clip_lower(0).std(axis=0) + stock_res.clip_upper(0).std(axis=0)
        # ----以下勿改动----
