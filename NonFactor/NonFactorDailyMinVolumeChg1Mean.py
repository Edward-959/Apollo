...
class NonFactorDailyMinVolumeChg1Mean(DailyMinFactorBase):
    ...
    def single_stock_factor_generator(self, code):
        ...
        if stock_minute_data.columns.__len__() > 0 and data_check_df.__len__() > 0:
            ...
            stock_volume_ratio = stock_minute_volume/(stock_minute_volume.shift(1, axis=1)) - 1
            factor_data = stock_volume_ratio.mean(axis = 1)
