...
factors_need_updated_list = \
    [
        ["DataDailyAdjfactor", {}, "Data_adjfactor.h5"],
        ["DataDailyFreeFloatShares", {}, "Data_free_float_shares.h5"],
        ["DataDailyGeneral", {'item': 'S_DQ_OPEN'}, "Data_open.h5"],
        ["DataDailyGeneral", {'item': 'S_DQ_CLOSE'}, "Data_close.h5"],
        ["DataDailyGeneral", {'item': 'S_DQ_AMOUNT'}, "Data_amt.h5"],
        ["DataDailyGeneral", {'item': 'S_DQ_VOLUME'}, "Data_volume.h5"],
        ["DataDailyGeneral", {'item': 'S_DQ_HIGH'}, "Data_high.h5"],
        ["DataDailyGeneral", {'item': 'S_DQ_LOW'}, "Data_low.h5"],
        ["DataDailyGeneral", {'item': 'S_DQ_PRECLOSE'}, "Data_pre_close.h5"],
        ["DataDailyGeneral", {'item': 'S_DQ_PCTCHANGE'}, "Data_pct_chg.h5"],
        ["DataDailyMktCapArd", {}, "Data_mkt_cap_ard.h5"],
        ["DataDailyTotalShares", {}, "Data_total_shares.h5"],
        ["DataDailyTurn", {}, "Data_turn.h5"],
        ["DataDailyAlphaUniverse", {}, "Data_alpha_universe.h5"],
        ["DataDailyRiskUniverse", {}, "Data_risk_universe.h5"],
    ]
...
for i_factor in factors_need_updated_list:
    ...
    if i_factor[0][0:12] == "DataDailyMin":
        ...
        complete_stock_list_and_index.extend(["000001.SH", "000016.SH", "000300.SH", "000905.SH", "000906.SH",
                                              "399001.SZ", "399006.SZ"])
        factor_obj = class_name(alpha_data_root_path, complete_stock_list_and_index, valid_start_date, end_date,
                                i_factor[1])
    else:
        factor_obj = class_name(alpha_data_root_path, valid_start_date, end_date, i_factor[1])
    # 计算因子
