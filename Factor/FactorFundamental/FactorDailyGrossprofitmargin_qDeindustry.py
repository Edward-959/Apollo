...
class FactorDailyGrossprofitmargin_qDeindustry(DailyFactorBase):
    ...
    def factor_calc(self):
        ...
        factor_data = Dtk.get_panel_daily_info(self.stock_list, valid_start, self.end_date, "qfa_grossprofitmargin")
