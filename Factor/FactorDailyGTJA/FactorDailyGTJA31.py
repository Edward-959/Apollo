# -*- coding: utf-8 -*-
# @Time    : 2018/11/15 12:38
# @Author  : 011673
# @File    : FactorDailyGTJA31.py
# -*- coding: utf-8 -*-
...
def factor_generator(stock_list, start_date, end_date, factor_file_dir_path, factor_file_name, k):
    ...
    data_close_mean = data_close.rolling(window=12, min_periods=1).mean()
    # 计算因子值
    factor_data = 100 * (data_close / data_close_mean - 1)
...
def main():
    ...
    for i_lag in [3, 5]:
        k = i_lag
        factor_name = "F_D_GTJA31" + '_' + str(k)
