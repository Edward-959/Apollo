...
def factor_generator(stock_list, start_date, end_date, factor_file_dir_path, factor_file_name, lag, rank_universe):
    ...
    temp1 = data_open - data_vwap.rolling(lag).mean()
    temp1 = temp1[universe == 1].rank(1)
    temp2 = data_close - data_vwap
    temp2 = temp2.abs()
    temp2 = -temp2[universe == 1].rank(1)

    factor_data = temp1 * temp2
...
def main():
    ...
    for lag in [5, 10, 15]:
        factor_name = "F_D_GTJA12"+'Lag'+str(lag)
