...
class FactorDailyMomentumDeindustry(DailyFactorBase):
    ...
    def factor_calc(self):
        ...
        factor_data = close / close.shift(20) - 1
        industry = Dtk.get_panel_daily_info(self.stock_list, start_date_minus_k_2, self.end_date, info_type='industry3')
        result = None
        for i in range(1, 32):
