...
class NonFactorDailyMinRet5Mean(DailyMinFactorBase):
    ...
    def single_stock_factor_generator(self, code):
        ...
        if stock_minute_data.columns.__len__() > 0 and data_check_df.__len__() > 0:
            ...
            stock_5minute_close = stock_minute_close[temp_min_list]
            stock_close_ratio = stock_5minute_close/stock_5minute_close.shift(1, axis=1) - 1
            factor_data = stock_close_ratio.mean(axis = 1)
