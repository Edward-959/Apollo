...
class NonFactorDailyMinVolumeCloseCorr(DailyMinFactorBase):
    ...
    def single_stock_factor_generator(self, code):
        ...
        if stock_minute_data.columns.__len__() > 0 and data_check_df.__len__() > 0:
            ...
            stock_corr_series = stock_minute_close.corrwith(stock_minute_volume, axis=1)
            factor_data = stock_corr_series
