...
class FactorDailyStockStdBetaIndex(DailyFactorBase):
    ...
    def factor_calc(self):
        # ---- 1. 请设定对应的因子原始值文件-------
        corresponding_non_factor_file = "NF_D_StockStdBetaIndex_25.h5"
        # ---- 第1部分到此为止，其他部分勿改动 ----
        ...
        ans_df = factor_original_df.ewm(span=self.n).mean()
        # ---- 第2部分到此为止，以下勿改动----------
