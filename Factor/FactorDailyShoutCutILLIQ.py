# -*- coding: utf-8 -*-
# @Time    : 2018/11/29 15:34
# @Author  : 011673
# @File    : FactorDailyShoutCutILLIQ.py
# 采用2*(high-low)-abs(open-close)代替ret的ILLIQ
import DataAPI.DataToolkit as Dtk
from Factor.DailyFactorBase import DailyFactorBase
import os


class FactorDailyShoutCutILLIQ(DailyFactorBase):
    ...
    def factor_calc(self):
        # ---- 1. 请设定对应的因子原始值文件-------
        corresponding_non_factor_file = "NF_D_ShoutCutILLIQ_{}.h5".format(self.n)
        # ---- 第1部分到此为止，其他部分勿改动 ----
