...
class NonFactorDailyMinOCVP(DailyMinFactorBase):
    ...
    def single_stock_factor_generator(self, code):
        ...
        if stock_minute_data.columns.__len__() > 0 and data_check_df.__len__() > 0:
            ...
            stock_minute_volume_call_auction = stock_minute_volume.loc[:, 925]
            stock_minute_volume_all_day = stock_minute_volume.sum(axis=1)
            factor_value = stock_minute_volume_call_auction / stock_minute_volume_all_day
