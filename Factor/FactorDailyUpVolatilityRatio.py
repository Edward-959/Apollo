# -*- coding: utf-8 -*-
# @Time    : 2018/11/27 8:49
# @Author  : 011673
# @File    : FactorDailyUpVolatilityRatio.py
# 上行波动率占比
...
class FactorDailyUpVolatilityRatio(DailyFactorBase):
    ...
    def factor_calc(self):
        # ---- 1. 请设定对应的因子原始值文件-------
        corresponding_non_factor_file = "NF_D_UpVolatilityRatio_20.h5"
        # ---- 第1部分到此为止，其他部分勿改动 ----
