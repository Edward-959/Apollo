# -*- coding: utf-8 -*-
# @Time    : 2018/12/19 10:35
# @Author  : 011673
# @File    : FactorDailyMinVolumeRatio.py
...
class FactorDailyMinVolumeRatio(DailyFactorBase):
    ...
    def factor_calc(self):
        # ---- 1. 请设定对应的因子原始值文件-------
        corresponding_non_factor_file = "NF_D_MinVolumeRatio_ema.h5"
        # ---- 第1部分到此为止，其他部分勿改动 ----
