...
class FactorDailyEPDeindustry(DailyFactorBase):
    ...
    def factor_calc(self):
        ...
        factor_data = Dtk.get_panel_daily_info(self.stock_list, valid_start, self.end_date, "pe_ttm")
        industry = Dtk.get_panel_daily_info(self.stock_list, valid_start, self.end_date, info_type='industry3')
        factor_data = np.reciprocal(factor_data)
