...
class NonFactorDailyMinCloseToAvgPrice(DailyMinFactorBase):
    ...
    def single_stock_factor_generator(self, code):
        ...
        if stock_minute_data.columns.__len__() > 0 and data_check_df.__len__() > 0:
            ...
            stock_minute_vwap = stock_minute_amt / stock_minute_vol
            stock_minute_vwap_chg = stock_minute_close / stock_minute_vwap - 1
            factor_data = stock_minute_vwap_chg.sum(axis=1)
