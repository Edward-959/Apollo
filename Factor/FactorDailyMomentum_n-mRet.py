# -*- coding: utf-8 -*-
# @Time    : 2018/11/21 19:22
# @Author  : 011673
# @File    : FactorDailyMomentum_n-mRet.py
...
def factor_generator(stock_list, start_date, end_date, factor_file_dir_path, factor_file_name, n, m):
    ############################################
    ...
    factor_data = (close / close.shift(n) - 1) - (close / close.shift(m) - 1)
...
def main():
    ...
    n = 60
    m = 20
    factor_name = "F_D_Momentum_{}-{}Ret".format(n,m)
    file_name = factor_name
    factor_generator(stock_code_list, istart_date_int, iend_date_int, save_dir, file_name, n, m)
