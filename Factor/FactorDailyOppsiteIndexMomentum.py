...
class FactorDailyOppsiteIndexMomentum(DailyFactorBase):
    ...
    def factor_calc(self):
        # ---- 1. 请设定对应的因子原始值文件-------
        corresponding_non_factor_file = "NF_D_OppsiteIndexMomentum.h5"
        # ---- 第1部分到此为止，其他部分勿改动 ----
        ...
        # ---- 2. 对因子原始值求ema ----------------
        ans_df =  factor_original_df.ewm(ignore_na=False, com=self.n).mean()
        # ---- 第2部分到此为止，以下勿改动----------
